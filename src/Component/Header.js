    ...
    <div>
      <nav className="navbar navbar-dark navbar-expand-md fixed-top bg-light">
        <div className="container">
          ...
          <button className="navbar-toggler bg-info text-white" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
